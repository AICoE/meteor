// Copied from https://github.com/RedHatInsights/landing-page-frontend/blob/master/src/components/icon-404.js

import React from 'react';

import styles from './NotFoundIcon.module.scss';
    ...
    <defs>
      <mask id="mask" x="0" y="0" width="131" height="131" maskUnits="userSpaceOnUse">
        <g transform="translate(-2.89 -3.07)">
          <g id="mask-2">
            <polygon id="path-1" className={styles.cls_1} points="2.89 134.07 133.89 134.07 133.89 3.07 2.89 3.07 2.89 134.07" />
          </g>
        </g>
      </mask>
    </defs>
    <title>404path-not-found</title>
    <g className={styles.cls_2}>
      <g id="Group">
        <g id="Page-1">
          <path
            id="Fill-1"
